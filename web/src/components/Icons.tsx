...
export function ChevRightIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...baseProps} {...p}>
...
export function StarIcon(p: SVGProps<SVGSVGElement> & { filled?: boolean }) {
  const { filled, ...rest } = p;
  return (
...
export function SettingsIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...baseProps} {...p}>
      ...
      <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6c.63.26 1.27.4 1.91.42L12 5l1.09-.08c.64-.02 1.28-.16 1.91-.42a1.65 1.65 0 0 0 1.82.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.26.63.4 1.27.42 1.91L20 12l-.08 1.09c-.02.64-.16 1.28-.52 1.91z" />
    </svg>
  );
}
...
export function GitCommitIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...baseProps} {...p}>
      <circle cx="12" cy="12" r="4" />
...
export function FlagIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...baseProps} {...p}>
      <path d="M4 22V4a2 2 0 0 1 2-2h11l4 5-4 5H6" />
...
export function FolderPlusIcon(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...baseProps} {...p}>
      <path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
