...
const contentBase =
  "z-modal min-w-[12rem] overflow-hidden rounded-2 border border-border bg-surface-elev p-1 text-fg-1 shadow-2 " +
...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(itemBase, inset && "pl-7", "data-[state=open]:bg-hover", className)}
    {...props}
  >
    {children}
    <ChevronRightIcon className="ml-auto h-3.5 w-3.5 text-fg-3" />
  </ContextMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, destructive, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      itemBase,
      inset && "pl-7",
      destructive && "text-callout-danger focus:bg-callout-danger/10",
      className,
    )}
    {...props}
  />
